...
Out of the 100 simulations, `r sum_z` estimates are statistically significant. I determined this by counting how many z scores were greater than 2 or less than -2 (logic taken from Gelman and Hill "if the absolute value of the z-score exceeds 2, the estimate is statistically significant"). 
